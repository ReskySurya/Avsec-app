        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-5">
                <div class="flex justify-between items-center">
                    <div>
                        <h2 class="text-xl font-bold text-white mb-1">Logbook Rotasi PSCP</h2>
                    </div>
                    <div class="bg-blue-500 text-white px-4 py-2 rounded-full font-semibold text-sm">
                        {{ $logbooksPSCP->count() }} Data
                    </div>
                </div>
            </div>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr>
                            <td colspan="4" class="px-4 py-12 text-center">
                                ...
                                <p class="text-gray-400">Logbook PSCP akan muncul di sini setelah dibuat</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
    ...
    <div class="mb-10">
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
            ...
            <div class="bg-gradient-to-r from-green-600 to-green-700 px-6 py-5">
                <div class="flex justify-between items-center">
                    <div>
                        <h2 class="text-xl font-bold text-white mb-1">Logbook Rotasi HBSCP</h2>
                    </div>
                    <div class="bg-green-500 text-white px-4 py-2 rounded-full font-semibold text-sm">
                        {{ $logbooksHBSCP->count() }} Data
                    </div>
                </div>
            </div>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr>
                            <td colspan="4" class="px-4 py-12 text-center">
                                ...
                                <h3 class="text-lg font-semibold text-gray-500 mb-2">Belum Ada Data</h3>
                                <p class="text-gray-400">Logbook HBSCP akan muncul di sini setelah dibuat</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
