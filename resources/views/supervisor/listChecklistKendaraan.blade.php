        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-5">
                <div class="flex justify-between items-center">
                    <div>
                        <h2 class="text-xl font-bold text-white mb-1">Checklist Kendaraan Mobil Patroli</h2>
                    </div>
                        ...
                        <tr class="hover:bg-blue-50 transition-colors duration-200">
                            ...
                            <td class="px-4 py-4">
                                <div class="flex flex-col">
                                    <span class="font-semibold text-gray-900 text-base">{{ \Carbon\Carbon::parse($checklist->date)->translatedFormat('l') }}</span>
                                    <span class="text-sm text-gray-500">{{ \Carbon\Carbon::parse($checklist->date)->translatedFormat('d F Y') }}</span>
                                </div>
                            </td>
                            <td class="px-4 py-4">
                                <span class="bg-blue-100 text-blue-800 px-3 py-1 rounded-full font-semibold text-sm">
    ...
    <div class="mb-10">
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
            ...
            <div class="bg-gradient-to-r from-green-600 to-green-700 px-6 py-5">
                <div class="flex justify-between items-center">
                    <div>
                        <h2 class="text-xl font-bold text-white mb-1">Checklist Kendaraan Motor Patroli</h2>
                    </div>
