...
<div class="max-w-6xl mx-auto px-2 sm:px-4 py-4 sm:py-6 lg:pt-20">
    ...
    <div class="mb-8 sm:mb-10">
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
            ...
            <div class="block lg:hidden p-2 sm:p-4 space-y-3">
                @forelse($checklistsMobil as $checklist)
                <div
                    ...
                    <div class="space-y-2 mb-4">
                        <div class="flex items-center text-xs sm:text-sm text-gray-600">
                            ...
                            <span class="font-semibold text-gray-900">{{
                                \Carbon\Carbon::parse($checklist->date)->locale('id')->translatedFormat('l') }}</span>
                        </div>
                        ...
                        <div class="flex items-center text-xs sm:text-sm text-gray-600 mt-2">
                            ...
                            <span class="bg-blue-100 text-blue-800 px-2 py-0.5 rounded-full font-semibold">
                                Shift {{ ucfirst($checklist->shift) }}
                            </span>
                        </div>
                    </div>

                    <div class="pt-2 border-t border-gray-100">
                        <a href="{{ route('supervisor.checklist-kendaraan.detail', $checklist->id) }}"
                ...
                <div class="text-center py-8">
                    ...
                    <p class="text-xs sm:text-sm text-gray-400">Checklist Mobil akan muncul di sini setelah dibuat</p>
                </div>
                @endforelse
            </div>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr>
                            <td colspan="5" class="px-4 py-8 sm:py-12 text-center">
                                ...
                                <h3 class="text-base sm:text-lg font-semibold text-gray-500 mb-1">Belum Ada Data</h3>
                                <p class="text-xs sm:text-sm text-gray-400">Checklist Mobil akan muncul di sini setelah
                                    dibuat</p>
                            </td>
                        </tr>
                        @endforelse
    ...
    {{-- Checklist Kendaraan Motor Patroli --}}
    <div class="mb-8 sm:mb-10">
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
            {{-- Header --}}
            ...
            {{-- Mobile: Card Layout --}}
            <div class="block lg:hidden p-2 sm:p-4 space-y-3">
                @forelse($checklistsMotor as $checklist)
                <div
                    class="border border-gray-200 rounded-xl p-3 sm:p-4 bg-white shadow-sm hover:shadow-md transition-shadow">
                    <div class="flex justify-between items-start mb-3">
                ...
                <div class="text-center py-8">
                    ...
                    <h3 class="text-base sm:text-lg font-semibold text-gray-500 mb-1">Belum Ada Data</h3>
                    <p class="text-xs sm:text-sm text-gray-400">Checklist Motor akan muncul di sini setelah dibuat</p>
                </div>
                @endforelse
            </div>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr>
                            <td colspan="5" class="px-4 py-8 sm:py-12 text-center">
                                ...
                                <h3 class="text-base sm:text-lg font-semibold text-gray-500 mb-1">Belum Ada Data</h3>
                                <p class="text-xs sm:text-sm text-gray-400">Checklist Motor akan muncul di sini setelah
                                    dibuat</p>
                            </td>
                        </tr>
                        @endforelse
