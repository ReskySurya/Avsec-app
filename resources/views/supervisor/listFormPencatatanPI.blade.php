        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-3 sm:px-6 py-4 sm:py-5">
                <div
                    ...
                    <div>
                        ...
                        {{-- PERBAIKAN: Menampilkan total data yang difilter --}}
                        <p class="text-blue-100 text-xs sm:text-sm mt-1">
                            {{ $formPencatatanPI->total() }} data ditemukan
                            @if(request()->query('status'))
                    ...
                    <div
                        ...
                        {{-- PERBAIKAN: Menampilkan jumlah data di halaman saat ini dan totalnya --}}
                        {{ $formPencatatanPI->firstItem() ?? 0 }}-{{ $formPencatatanPI->lastItem() ?? 0 }} dari {{
                        $formPencatatanPI->total() }} Data
                    </div>
                </div>
            </div>
            ...
            <div class="block lg:hidden p-2 sm:p-4 space-y-3">
                ...
                <div
                    ...
                    <div class="space-y-2 mb-4">
                        ...
                        <div class="flex items-center text-xs sm:text-sm text-gray-600 mt-1">
                            <svg class="w-3 h-3 mr-2 text-gray-500" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
                                    d="M4 4a2 2 0 012-2h8a2 2 0 012 2v12a1 1 0 110 2h-1v-1a1 1 0 00-1-1H8a1 1 0 00-1 1v1H6a1 1 0 110-2V4zm3 1h2v2H7V5zm2 4H7v2h2V9zm2-4h2v2h-2V5zm2 4h-2v2h2V9z"
                                    clip-rule="evenodd"></path>
                            </svg>
                ...
                <div class="text-center py-8">
                    ...
                    <p class="text-xs sm:text-sm text-gray-400">Data Form Pencatatan PI akan muncul di sini setelah
                        dibuat</p>
                </div>
                @endforelse
            </div>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr>
                            <td colspan="7" class="px-4 py-8 sm:py-12 text-center">
                                ...
                                <h3 class="text-base sm:text-lg font-semibold text-gray-500 mb-1">Belum Ada Data</h3>
                                <p class="text-xs sm:text-sm text-gray-400">Data Form Pencatatan PI akan muncul di sini
                                    setelah dibuat</p>
                            </td>
                        </tr>
                        @endforelse
            ...
            @if($formPencatatanPI->hasPages())
            <div class="mt-4 sm:mt-6 px-2 sm:px-4 pb-4 flex justify-center">
                {{-- PERBAIKAN: Pagination sudah otomatis menangani filter karena perubahan di controller --}}
