<div id="sidebar" class="bg-gray-800 text-white w-64 min-h-screen p-4 fixed top-16 lg:top-0 left-0 z-30 transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out lg:pt-4">
    ...
    <nav class="lg:mt-20 sm:mt-0">
        <ul class="space-y-2">
            <!-- Dashboard - All Roles -->
            <li>
                <a href="{{ url('/dashboard/' . auth()->user()->role->name) }}" class="flex items-center p-2 rounded hover:bg-gray-700 {{ request()->is('dashboard/*') ? 'bg-gray-700' : '' }}">
