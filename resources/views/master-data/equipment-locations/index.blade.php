...
<div x-data="{
    ...
    <div class="mb-8 mt-20">
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6">
            <div class="mb-8">
                <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Equipment & Location</h1>
                <p class="text-gray-600">Kelola peralatan dan lokasi dengan mudah</p>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200">
                ...
                <div class="bg-gray-50 px-5 py-3 flex justify-end space-x-2">
                    ...
                    <form action="{{ route('equipment-location.destroy', $el->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus relasi ini?')">
                        @csrf
                        @method('DELETE')
                        <button type="submit"  onclick="return confirm('Yakin ingin menghapus?')" class="p-2 bg-red-100 text-red-600 rounded-full hover:bg-red-200 transition-colors duration-200">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
