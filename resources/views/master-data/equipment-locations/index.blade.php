                    ...
                    <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                        <div>
                            <p class="text-sm text-gray-700">Menampilkan <span class="font-medium">1</span> sampai <span
                                    class="font-medium">{{ count($equipmentLocations) }}</span> dari <span
                                    class="font-medium">{{
        count($equipmentLocations) }}</span> hasil</p>
                        </div>
                        <div>
                                ...
                                <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                                    <div>
                                        <p class="text-sm text-gray-700">Menampilkan <span class="font-medium">1</span> sampai
                                            <span class="font-medium">{{ count($equipmentList) }}</span> dari <span
                                                class="font-medium">{{ count($equipmentList) }}</span> hasil
                                        </p>
                                    </div>
                                    <div>
                                            ...
                                            <div>
                                                <p class="text-sm text-gray-700">Menampilkan <span class="font-medium">1</span> sampai
                                                    <span class="font-medium">{{ count($locationList) }}</span> dari <span
                                                        class="font-medium">{{count($locationList) }}</span> hasil</p>
                                            </div>
                                            <div>
                                                <nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px"
                                                    aria-label="Pagination">
