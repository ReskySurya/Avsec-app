...
<div x-data="{}" class="container mx-auto p-4 max-w-full mt-20">
    ...
    <!-- Search Form -->
    <div class="mb-8">
        <form action="{{ route('sweepingPI.index') }}" method="GET">
            <div class="relative">
                <input type="text" name="search" placeholder="Cari tenant berdasarkan nama atau ID..."
                       value="{{ $search ?? '' }}"
                       class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl shadow-sm focus:ring-blue-500 focus:border-blue-500">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 md:hidden">
            ...
            <div class="group bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 border border-gray-200 overflow-hidden cursor-pointer"
                ...
                <div class="p-6">
                    ...
                    <p class="text-gray-600 text-sm leading-relaxed">Klik untuk mengelola logbook sweeping.</p>
                </div>
            </div>
            @empty
