        ...
        <div @click.away="openLogbook = false" class="bg-white w-full max-w-md rounded-2xl shadow-2xl">
            ...
            <form action="{{ route('logbook.store') }}" method="POST" class="p-6">
                ...
                <div class="mb-6">
                    ...
                    @php
                    $sweppingLocation = $locations->first(); // Ambil location pertama (Sweeping PI)
                    @endphp

                    <!-- Input Text Readonly untuk menampilkan nama lokasi -->
                    ...
                    <!-- Hidden input untuk menyimpan ID lokasi -->
