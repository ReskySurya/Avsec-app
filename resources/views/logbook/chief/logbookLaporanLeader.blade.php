...
<div x-data="{
    ...
    <div class="bg-white shadow-xl rounded-2xl overflow-hidden mb-8 border border-gray-100">
        <div class="bg-gradient-to-r from-blue-500 to-teal-600 px-6 py-6 text-white">
            <div class="flex flex-col sm:flex-row justify-between items-start">
                <div>
                    <h3 class="text-2xl font-bold mb-1">{{ 'Logbook Chief' }}</h3>
                    <p class="text-blue-100">Catatan aktivitas harian Supervisor</p>
                </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 p-6 md:hidden">
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200"
                @click="window.location.href='{{ route('logbook.chief.detail', ['id' => $logbook->logbookID]) }}'">
                <div class="p-5">
                ...
                <div class="bg-gray-50 px-5 py-3 flex justify-end space-x-2">
                    ...
                    <form action="{{ route('logbook.chief.delete', $logbook->logbookID) }}" method="POST"
        ...
        <div class="overflow-x-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100 hidden md:block">
            <table class="min-w-full">
                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse($chiefLogbooks ?? [] as $index => $logbook)
                    <tr @click="window.location.href='{{ route('logbook.chief.detail', ['id' => $logbook->logbookID]) }}'"
            ...
            @if(isset($chiefLogbooks) && method_exists($chiefLogbooks, 'links'))
    ...
    <div x-show="openLogbook" x-transition:enter="transition ease-out duration-300"
        ...
        <div @click.away="openLogbook = false" class="bg-white w-full max-w-md rounded-2xl shadow-2xl">
            ...
            <form action="{{ route('logbook.chief.store') }}" method="POST" class="p-6">
                @csrf
                <div class="mb-6">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Form validation (tetap menggunakan Alpine.js untuk validasi)
        const form = document.querySelector('form[action="{{ route('logbook.chief.store') }}"]');
        if (form) {
