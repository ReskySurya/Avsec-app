...
<div class="max-w-4xl mx-auto bg-white p-6 mt-6 shadow-md border text-sm">
    ...
    <table class="w-full border border-black mb-6 text-sm">
        ...
        <tbody>
            @foreach($kemajuanPersonil as $index => $kemajuanPersonil)
            <tr>
                <td class="border border-black px-2 py-1 text-center">{{ $index + 1 }}</td>
                <td class="border border-black px-2 py-1 text-center">{{ $kemajuanPersonil->jml_personil }}</td>
                <td class="border border-black px-2 py-1 text-center">{{ $kemajuanPersonil->jml_hadir }}</td>
                <td class="border border-black px-2 py-1 text-center">{{ $kemajuanPersonil->jml_kekuatan }}</td>
                <td class="border border-black px-2 py-1">{{ $kemajuanPersonil->materi }}</td>
                <td class="border border-black px-2 py-1 text-center">{{ $kemajuanPersonil->keterangan }}</td>
            </tr>
            @endforeach
        </tbody>
    </table>
    ...
    <div class="mt-10 text-center text-sm">
        <div class="grid grid-cols-2 gap-4">
            ...
            <div>
                ...
                <p class="font-semibold mt-1">{{ $logbook->approvedBy->name?? '-' }}</p>
            </div>
            ...
            <div>
                ...
                <p class="font-semibold mt-1">{{ $logbook->createdBy->name?? '-' }}</p>
            </div>
        </div>
    </div>
</div>
