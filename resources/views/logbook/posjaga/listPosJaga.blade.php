    ...
    <div class="bg-white shadow-xl rounded-2xl overflow-hidden border border-gray-100">
        <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-6">
            <div class="flex flex-col sm:flex-row justify-between items-start">
                <div>
                    ...
                    <p class="text-gray-500">Logbook Anda telah disimpan sebagai draft. Silakan lengkapi formulir terkait di bawah ini.</p>
                </div>
            </div>
        </div>
        ...
        <div class="p-6 border-b border-gray-200">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div class="flex items-center">
                    <svg class="w-5 h-5 mr-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3a1 1 0 011-1h2a1 1 0 011 1v4m-5 4h10M3 11h18M4 15h16M4 19h16"></path></svg>
                    <span class="text-gray-600"><strong class="font-medium text-gray-800">Tanggal:</strong> {{ \Carbon\Carbon::parse($logbook->date)->isoFormat('dddd, D MMMM YYYY') }}</span>
                </div>
                <div class="flex items-center">
                    <svg class="w-5 h-5 mr-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                    <span class="text-gray-600"><strong class="font-medium text-gray-800">Area:</strong> {{ $logbook->locationArea->name ?? 'N/A' }}</span>
                </div>
                <div class="flex items-center">
                    <svg class="w-5 h-5 mr-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                    <span class="text-gray-600"><strong class="font-medium text-gray-800">Grup:</strong> {{ $logbook->grup ?? 'N/A' }}</span>
                </div>
                <div class="flex items-center">
                    ...
                    <span class="text-gray-600"><strong class="font-medium text-gray-800">Shift:</strong> {{ ucfirst($logbook->shift ?? 'N/A') }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="p-6">
            ...
            <div class="bg-white border border-gray-200 rounded-lg p-4 flex items-center justify-between">
                ...
                <p class="text-sm text-gray-500">Formulir utama untuk uraian kegiatan, personil, dan fasilitas.</p>
                </div>
            ...
            <div class="bg-white border border-gray-200 rounded-lg p-4 flex items-center justify-between">
                ...
                <p class="text-sm text-gray-500">Formulir untuk jadwal rotasi personil di area {{ $logbook->locationArea->name }}.</p>
                </div>
