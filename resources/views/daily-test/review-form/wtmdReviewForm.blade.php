    ...
    <div class="bg-white shadow-md rounded px-4 sm:px-8 pt-6 pb-8 mb-4 w-full max-w-full">
        ...
        <div class="bg-white p-4 w-full max-w-full">
            <div id="format" class="mx-auto w-full">
                    ...
                    <div class="px-4">
                        ...
                        <div class="grid grid-cols-2 border-x-2 border-t-2 border-black text-center items-center">
                            <div class="relative ">
                                ...
                                <div class="absolute inset-0 flex flex-col items-start pt-20 lg:pt-64 pointer-events-auto ">
                                    <div class="mb-1">
                                        <div class="flex items-center gap-1">
                                            <div class="flex flex-col gap-2">
                                                <div class="flex items-center gap-1 pl-2.5">
                                                    ...
                                                    <input type="checkbox"
                                                        {{$form->reportDetails->first()->test1_in_depan ? 'checked' : '' }} disabled>
                                                </div>
                                                <div class="flex items-center gap-1">
                                                    <span class="text-[10px]">OUT</span>
                                                    <input type="checkbox"
                                                        {{$form->reportDetails->first()->test1_out_depan ? 'checked' : '' }} disabled>
                                                </div>
                                            </div>
                                        ...
                                        <div class="flex items-center gap-1">
                                            <div class="flex flex-col gap-2">
                                                <div class="flex items-center gap-1 pl-2.5">
                                                    <span class="text-[10px]">IN</span>
                                                    <input type="checkbox"
                                                        {{$form->reportDetails->first()->test2_in_depan ? 'checked' : '' }} disabled>
                                                </div>
                                                <div class="flex items-center gap-1">
                                                    <span class="text-[10px]">OUT</span>
                                                    <input type="checkbox"
                                                        {{$form->reportDetails->first()->test2_out_depan ? 'checked' : '' }} disabled>
                                                </div>
                                            </div>
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none"
                                                viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <div class="flex items-center gap-1">
                                            <div class="flex flex-col gap-2">
                                                <div class="flex items-center gap-1 pl-2.5">
                                                    <span class="text-[10px]">IN</span>
                                                    <input type="checkbox"
                                                        {{$form->reportDetails->first()->test4_in_depan ? 'checked' : '' }} disabled>
                                                </div>
                                                <div class="flex items-center gap-1">
                                                    <span class="text-[10px]">OUT</span>
                                                    <input type="checkbox"
                                                        {{$form->reportDetails->first()->test4_out_depan ? 'checked' : '' }} disabled>
                                                </div>
                                            </div>
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none"
                                                viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <div class="flex items-center gap-1">
                                            ...
                                            <div class="flex flex-col gap-2">
                                                <div class="flex items-center gap-1 pr-2.5">
                                                    <input type="checkbox"
                                                        {{$form->reportDetails->first()->test3_in_belakang ? 'checked' : '' }} disabled>
                                                    <span class="text-[10px]">IN</span>
                                                </div>
                                                <div class="flex items-center gap-1">
                                                    <input type="checkbox"
                                                        {{$form->reportDetails->first()->test3_out_belakang ? 'checked' : '' }} disabled>
                                                    <span class="text-[10px]">OUT</span>
                                                </div>
                                            </div>
                                        </div>
                ...
                <form action="{{ route('wtmd.updateStatus', $form->reportID) }}" method="POST" class="mt-2 sm:mt-4"
                    id="wtmdForm">
                    @csrf
                    @method('PATCH')
